<div class="w-full h-40 shadow-md rounded-xl p-4 bg-white dark:bg-slate-600 relative">
    <h2 class="text-lg mb-2 text-slate-500 dark:text-slate-400 leading-tight">Tabela de preços</h2>
    <div class="w-full flex justify-between items-center mb-2">
        <p class="text-sm dark:text-white">OURO</p>

        <div class='flex flex-col items-end justify-center'>
            <p class="text-sm font-bold text-black dark:text-white">R$ {{ $data->price_gold ?? 0, 2 }}</p>
    ...
    <div class="w-full flex justify-between items-center mb-2">
        <p class="text-sm dark:text-white">PRATA</p>

        <div class='flex flex-col items-end justify-center'>
            <p class="text-sm font-bold text-black dark:text-white">R$ {{ $data->price_silver ?? 0, 2 }}</p>
    ...
    <p class="text-xs text-slate-500 dark:text-slate-400 leading-tight">Última atualização {{ $data->created_at }}</p>
</div>
