<div>
    <div class="w-full flex flex-col lg:flex-row md:flex-row justify-between items-center p-3 mt-3">
        ...
        <div class="flex justify-end items-center my-4 md:my-0 lg:my-0"><p>Total de categorias:</p> <span class="flex justify-center items-center text-white bg-green-500 p-4 w-4 h-4 rounded-full ml-2">{{ $count }}</span></div>
    </div>
